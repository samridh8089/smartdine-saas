...
async function runTests() {
  console.log('Starting E2E verification against live production URL...');
  ...
  try {
    ...
    await page.goto('https://smartdine-qr.vercel.app', { waitUntil: 'networkidle2' });
    ...
    await page.goto('https://smartdine-qr.vercel.app/dashboard/menu', { waitUntil: 'networkidle2' });
    await waitForDashboardLoad(page);
    ...
    await sleep(5000); // wait for QR generation (needs network/Supabase call)
    ...
    await sleep(4000); // wait for redirect to tracking page
    ...
    await page.goto('https://smartdine-qr.vercel.app/dashboard/billing', { waitUntil: 'networkidle2' });
    await waitForDashboardLoad(page);
